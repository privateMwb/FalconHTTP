...
// spawns and joins threadCount real OS threads - at high iteration
// counts that could mean millions of real thread creations, which
// could make this benchmark take dramatically longer to run than the
// others in this suite (or be impractical to run at all). Watch this
// one's wall-clock time specifically; consider capping its iteration
// count if it stalls.
//
