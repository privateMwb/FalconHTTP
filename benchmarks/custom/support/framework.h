...
// clang-format off
#include <FalconHTTP/FalconHTTP.h>   // the class under the benchmarks.
...
// exportMarkdown()), and helpers.h (setSoloHeader(), setSuite()) — kept here
