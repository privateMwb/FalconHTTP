/**
 * @file HttpParser.cpp
 * @brief HttpParser implementation.
 *
 * Contains the implementation of HttpParser's public parse() entry point
 * and its private line/request-line/header/path parsing helpers.
 */

// ============================================================
// Implementation for FalconHTTP::HTTP::HttpParser.
// ============================================================
//
//  Sections:
//   1. Core API
...
// clang-format off
#include <FalconHTTP/HTTP/HttpParser.h>  // HttpParser (own header)
#include <FalconHTTP/HTTP/HttpMethod.h>  // methodFromString
#include <FalconHTTP/Utility/UrlDecoder.h> // UrlDecoder::decode
