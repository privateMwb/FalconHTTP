...
| Category | Focus |
|---|---|
| [Advanced](#advanced) | Deeper mechanics — server lifecycle, thread pool sizing, cache staleness, shared config |
| [Integration](#integration) | Interoperability with the rest of a codebase |
| [Misuse](#misuse) | Common mistakes and the errors or unexpected behavior they lead to |
